...
?>" name="files" id="files" method="post" enctype="multipart/form-data">
    ...
    "cftp_admin"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="file[<?php echo $i; ?>][name]" value="<?php echo $file->title; ?>" class="form-control" placeholder="<?php _e(
    ...
    "cftp_admin"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description_<?php echo $file->id; ?>" name="file[<?php echo $i; ?>][description]" class="<?php if (
    get_option("files_descriptions_use_ckeditor") == 1
) {
    echo "ckeditor";
} ?> form-control textarea_description" placeholder="<?php _e(
    ...
    "cftp_admin"
                                                ...
                                                <!-- MOVED: Discipline Field (now file-specific) -->
                                                <div class="form-group">
    ...
    "cftp_admin"
                                                ...
                                                <!-- MOVED: Deliverable Type Field (now file-specific) -->
                                                <div class="form-group">
    ...
    "cftp_admin"
                                                            ...
                                                            <div class="input-group date-container">
                                                                <input type="text" class="date-field form-control datapick-field readonly-not-grayed" readonly id="file_expiry_date_<?php echo $i; ?>" name="file[<?php echo $i; ?>][expiry_date]" value="<?php echo !empty(
    $file->expiry_date
)
    ? date("d-m-Y", strtotime($file->expiry_date))
    : date("d-m-Y"); ?>" />
                                                        ...
                                                        <div class="checkbox">
                                                            <label for="exp_checkbox_<?php echo $i; ?>">
                                                                <input type="checkbox" class="checkbox_setting_expires" name="file[<?php echo $i; ?>][expires]" id="exp_checkbox_<?php echo $i; ?>" value="1" <?php if (
    $file->expires
) { ?>checked="checked"<?php } ?> /> <?php _e("File expires", "cftp_admin"); ?>
                                                            </label>
                                                        </div>
                                                            ...
                                                            current_user_can_upload_public()
                                                                ...
                                                                <div class="checkbox">
                                                                    <label for="pub_checkbox_<?php echo $i; ?>">
                                                                        <input type="checkbox" class="checkbox_setting_public" id="pub_checkbox_<?php echo $i; ?>" name="file[<?php echo $i; ?>][public]" value="1" <?php if (
    $file->public
) { ?>checked="checked"<?php } ?>/> <?php _e(
...
EOL;
                                        ...
                                        if (CURRENT_USER_LEVEL != 0) { ?>
                                                <div class="col assigns">
                                                    <div class="file_data">
                                                        ...
                                                        <select class="form-select select2 assignments_clients none" multiple="multiple" id="clients_<?php echo $file->id; ?>" name="file[<?php echo $i; ?>][assignments][clients][]" data-file-id="<?php echo $file->id; ?>" data-type="clients" data-placeholder="<?php _e(
    ...
    echo ' selected="selected"';
                                                        ...
                                                        <div class="select_control_buttons">
                                                            <button type="button" class="btn btn-sm btn-primary add-all" data-target="clients_<?php echo $file->id; ?>"><?php _e(
    "Add all",
    "cftp_admin"
); ?></button>
                                                            <button type="button" class="btn btn-sm btn-primary remove-all" data-target="clients_<?php echo $file->id; ?>"><?php _e(
    "Remove all",
    "cftp_admin"
); ?></button>
                                                        </div>
                                                        ...
                                                        <select class="form-select select2 assignments_groups none" multiple="multiple" id="groups_<?php echo $file->id; ?>" name="file[<?php echo $i; ?>][assignments][groups][]" data-file-id="<?php echo $file->id; ?>" data-type="groups" data-placeholder="<?php _e(
    "Select one or more options. Type to search.",
    "cftp_admin"
); ?>">
                                                            <?php foreach (
    ...
    echo ' selected="selected"';
                                                        ...
                                                        <div class="select_control_buttons">
                                                            <button type="button" class="btn btn-sm btn-primary add-all" data-target="groups_<?php echo $file->id; ?>"><?php _e(
    "Add all",
    "cftp_admin"
); ?></button>
                                                            <button type="button" class="btn btn-sm btn-primary remove-all" data-target="groups_<?php echo $file->id; ?>"><?php _e(
    "Remove all",
    "cftp_admin"
); ?></button>
                                                        </div>
                                                        ...
                                                        <div class="checkbox">
                                                            <label for="hid_checkbox_<?php echo $i; ?>">
                                                                <input type="checkbox" class="checkbox_setting_hidden" id="hid_checkbox_<?php echo $i; ?>" name="file[<?php echo $i; ?>][hidden]" value="1" /> <?php _e(
                                                ...
                                                $generate_categories_options = generate_categories_options(
                                                    ...
                                                    <div class="categories">
                                                        <div class="file_data">
                                                            ...
                                                            <select class="form-select select2 none" multiple="multiple" id="categories_<?php echo $file->id; ?>" name="file[<?php echo $i; ?>][categories][]" data-type="categories" data-placeholder="<?php _e(
    "Select one or more options. Type to search.",
    "cftp_admin"
); ?>">
                                                            ...
                                                            <div class="select_control_buttons">
                                                                <button type="button" class="btn btn-sm btn-primary add-all" data-target="categories_<?php echo $file->id; ?>"><?php _e(
    "Add all",
    "cftp_admin"
); ?></button>
                                                                <button type="button" class="btn btn-sm btn-primary remove-all" data-target="categories_<?php echo $file->id; ?>"><?php _e(
    "Remove all",
    "cftp_admin"
); ?></button>
                                                            </div>
                                            ...
                                            <div class="folders">
                                                ...
                                                ?>
                                                <select class="form-select select2 none" id="folder_<?php echo $file->id; ?>" name="file[<?php echo $i; ?>][folder_id]" data-type="folder" data-placeholder="<?php _e(
...
document.addEventListener('DOMContentLoaded', function() {
    // Updated script to handle multiple discipline/deliverable type pairs
    const disciplineSelects = document.querySelectorAll('.discipline-select');
    
    disciplineSelects.forEach(function(disciplineSelect) {
        const fileIndex = disciplineSelect.id.split('_').pop(); // Extract file index from ID
